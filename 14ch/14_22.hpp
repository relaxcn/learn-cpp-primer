// 定义赋值运算符的一个新版本，使得我们能够把一个表示ISBN的string赋给一个Sales_sata对象
#ifndef CP5_CH14_EX14_21_H
#define CP5_CH14_EX14_21_H
...
Sales_data operator+(const Sales_data& lhs, const Sales_data& rhs) {
    Sales_data sum = lhs;
    sum.revenue = sum.revenue + lhs.revenue;
    sum.units_sold = sum.units_sold + lhs.units_sold;
    return sum;
}
